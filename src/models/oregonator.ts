...
export const oregonator: RDModel = {
  ...
  params: [
    ...
    },
    {
      ...
      description: "抑制種 v が u を抑える強さ。小さいと u が立ちっぱなしになり、1 付近で安定スパイラル、大きくすると抑制が勝って波が消えやすくなる (興奮性と静止の境界を制御)。スライダ上限を軸上限と同じ 2.6 に揃え、最悪ケースの反応項を抑えている。",
    },
    {
      key: "q", label: "閾値定数 q", symbol: "q",
      min: 0.001, max: 0.006, step: 0.0005, default: 0.002,
      axisEligible: true, axisRange: [0.0015, 0.005],
      description: "活性化の閾値スケール。大きくすると u の点火閾値が上がり波の立ち上がりが緩やかに、小さくすると鋭く尖った波先になる。下限を 0.005 に上げて (u−q)/(u+q) の u=0 付近の傾き (∝1/q) を緩め、反応ヤコビアンが過大にならないようにしている。",
    },
    {
